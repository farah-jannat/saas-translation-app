...
import DemoLanding from '../images/landingPages/landing_2.png';
  ...
  return (
    <main className="">
      <div className="relative isolate pt-14 dark:bg-gray-900">
        ...
        <div
          className="absolute inset-x-0 top-calc[(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-cacl[(100%-30rem)]"
          aria-hidden="true"
        >
          <div
